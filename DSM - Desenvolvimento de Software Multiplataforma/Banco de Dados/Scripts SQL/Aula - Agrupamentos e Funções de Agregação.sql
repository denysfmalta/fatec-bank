...
--3. Selecione a média dos preços e total em 
...
--6. Selecione a média dos preços dos produtos em 2 grupos: 
...
SELECT 
  CASE WHEN perecivel = 1 THEN 'perecível' ELSE 'não perecível' END AS tipo,
  AVG(valor) AS media_preco
FROM produtos
GROUP BY perecivel;

--7. Selecione a média dos preços dos 
...
--8. Selecione a média dos preços e 
